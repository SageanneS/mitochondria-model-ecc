...
class SlowTwitch():
   ...
   # Ion Concentrations and Nernst Potentials (Sarcolemma)
    ...
    def Main(self):
        ...
        # plt.show()
        io.savemat('4s_Normal.mat', {'X': X, 'Flux' : (ICA_t, JRYR, JSERCAT, JSERCA, JMCUT, JMCU, JNCXT, JNCX, JMPTPT, JMPTP, JANTT, JANT, JF1F0T, JF1F0, JETCT, JETC, JPDHT, JPDH, JAGCT, JAGC, NADM_t, NADM, JHleak_t, JHleak, Eh_t, Eh, JHYD_t, JHYD)})
