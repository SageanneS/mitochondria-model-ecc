...
class SlowTwitch():
   ...
   # Ion Concentrations and Nernst Potentials (Sarcolemma)
    ...
    V_ANT   = 8.123#float(sys.argv[2]) #8.123                                                            # WU uM/ms Rate constant of the adenine nucleotide translocator
    ...
    def Main(self):
        ...
        # plt.show()
        output_data_folder_path = "ANT={:.8f}".format(V_ANT)
        io.savemat('4s_ANT'+output_data_folder_path+'.mat', {'X': X, 'Flux' : (ICA_t, JRYR, JSERCAT, JSERCA, JMCUT, JMCU, JNCXT, JNCX, JMPTPT, JMPTP, JANTT, JANT, JF1F0T, JF1F0, JETCT, JETC, JPDHT, JPDH, JAGCT, JAGC, NADM_t, NADM, JHleak_t, JHleak, Eh_t, Eh, JHYD_t, JHYD)})
