...
class SlowTwitch():
   ...
   # Ion Concentrations and Nernst Potentials (Sarcolemma)
    ...
    k_ETC   = 0.764#0.191#float(sys.argv[2])                                                            # Korz (CI) uM/ms Rate constant of NADH oxidation by ETC
    ...
    def I_Ca_t(self, o_0, o_1, o_2, o_3, o_4, u, f_Ca, Cai_t, Cao_t):
        ...
        return g_Ca_t*((o_0 + o_1 + o_2 + o_3 + o_4))*(u - E_Ca_t)
    ...
    def J_RyR(self, ROS_t, o_0, o_1, o_2, o_3, o_4, f_Ca, CaSR_t, Cai_t):
        ...
        J_RYR = scale*((o_0 + o_1 + o_2 + o_3 + o_4))*(CaSR_t - Cai_t)  
    ...
    def Main(self):
        ...
        # plt.show()
        #output_data_folder_path = "ETC={:.8f}".format(k_ETC)
      #  io.savemat('4s_'+output_data_folder_path+'_10pc.mat', {'X': X, 'Flux' : (ICA_t, JRYR, JSERCAT, JSERCA, JMCUT, JMCU, JNCXT, JNCX, JMPTPT, JMPTP, JANTT, JANT, JF1F0T, JF1F0, JETCT, JETC, JPDHT, JPDH, JAGCT, JAGC, NADM_t, NADM, JHleak_t, JHleak, Eh_t, Eh, JHYD_t, JHYD)})
        io.savemat('/scratch/16201854/40Hz_MU_1_Healthy.mat', {'X': X, 'Flux' : (ICA_t, JRYR, JSERCAT, JSERCA, JMCUT, JMCU, JNCXT, JNCX, JMPTPT, JMPTP, JANTT, JANT, JF1F0T, JF1F0, JETCT, JETC, JPDHT, JPDH, JAGCT, JAGC, NADM_t, NADM, JHleak_t, JHleak, Eh_t, Eh, JHYD_t, JHYD)})
